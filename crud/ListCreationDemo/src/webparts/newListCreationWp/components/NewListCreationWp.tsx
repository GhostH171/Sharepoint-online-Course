...
export default class NewListCreationWp extends React.Component<
  INewListCreationWpProps,
  {}
> {
  ...
  public render(): React.ReactElement<INewListCreationWpProps> {
    ...
    return (
      <section
        className={`${styles.newListCreationWp} ${
      ...
      >
        ...
        <br></br>
        <p>
          Please fill out the below details to create a new list dynamically
        </p>{" "}
        <br></br>
        New list name: <br></br> <input type="text" id="txtListName"></input>
        <br></br>
        <br></br>
        new list desc:<br></br> <input type="text" id="txtListDesc"></input>
        <br></br>
        <br></br>
        <input
          type="button"
  ...
  public CreateNewList = () => {
    ...
    const listURL =
      this.props.siteUrl + "/_api/web/lists/GetbyTitle('" + newListName + "')";
