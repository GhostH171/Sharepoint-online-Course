...
import NewListCreationWp from './components/NewListCreationWp';
import { INewListCreationWpProps } from './components/INewListCreationWpProps';
...
export default class NewListCreationWpWebPart extends BaseClientSideWebPart<INewListCreationWpWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<INewListCreationWpProps> = React.createElement(
      NewListCreationWp,
      {
